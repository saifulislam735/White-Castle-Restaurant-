...
const Testimonial = () => {
    ...
    return (
        <section>
            ...
            <CarouselProvider className="my-6"
                naturalSlideWidth={70}
                naturalSlideHeight={5}
                totalSlides={3}
            >
                <Slider>
                    <Slide className="space-y-2 text-center " index={0}>
                        <p className="text-xl text-[#444] ">Various version have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like). It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                        <h2 className="text-[#CD9003] text-3xl">JANE DOE</h2>
                    </Slide>
                    <Slide className="space-y-2 text-center mt-4" index={0}>
                        <p className="text-xl text-[#444] ">Various version have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like). It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                        <h2 className="text-[#CD9003] text-3xl">JANE DOE</h2>
                    </Slide>
                    <Slide className="space-y-2 text-center mt-4" index={0}>
